angular.module('weatherExtApp').factory('WeatherModel', ['WeatherService', 'GeoIpService', 'WEATHER_API_UNITS', 'GooglePlacesService', 'PreferencesService', 'BrowserUtil',
    function(WeatherService, GeoIpService, WEATHER_API_UNITS, GooglePlacesService, PreferencesService, BrowserUtil) {
